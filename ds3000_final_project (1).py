...
params = {
    'objective': 'multi:softmax',  # Use softmax function for multi-class classification
    'num_class': len(np.unique(y_train)),  # Specify the number of unique classes
